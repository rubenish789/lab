...
class Snake:
    ...
    def drawingSnake(self):
        ...
        headTexture = pygame.image.load(r'snakehead.png')
...
font = pygame.font.Font(r'font.ttf', 25) # imporing our font, from our file
...
wall_texture = pygame.image.load(r'cobble4040.png')
wall_coordinates = []
pause = pygame.image.load(r'pause.png')
